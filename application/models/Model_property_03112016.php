...
//        $query = $this->db->query($sql);
    ...
    public function InsertAllProperties_intoTemp($city = 'Gandia', $data_entry = null, $data_output = null, $persons = 4, $desde = 0, $num = 0, $order = "ASC") {
     //   echo "InsertAllProperties_intoTemp($city , $data_entry, $data_output, $persons)<br>";

        //echo "FECHA_ENTRADA:[$data_entry]<BR>"; 12-09-2016
      ...
      //  echo "ONLY-APARTAMENTS:".date('H:i:s')."<br>";
