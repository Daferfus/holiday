...
class Model_blog extends CI_Model {
    ...
    public function GetLastPosts($num_posts) {
        ...
        $sql = "SELECT *,DATE_FORMAT(post_date,'%b') as mes,
            ...
            FROM gnr_post
            WHERE post_folder='es' AND post_visible='Mostrar' 
             AND post_type = 'post'
    ...
    public function GetNumPosts() {
        ...
        $sql = "SELECT count(*) as num
              FROM gnr_post  
              WHERE post_folder='$carpeta' AND post_visible='Mostrar' AND post_date < '$date' AND post_type='post' ";
//      echo $sql;
        $query = $this->db->query($sql);
    ...
    public function GetPost($post_slug = null) {
      //  echo "GETPOST[$post_slug]";
        if ($post_slug == null || empty($post_slug))
            return;
    /*    if ($post_slug == "alquiler-vacacional") {
            return $this->GetPostEx($post_slug);
        }*/
...
//      else
        ...
        //$where = " AND post_folder='$carpeta' AND post_slug LIKE '%$post_slug%' AND post_visible='Mostrar' ";
        
        $where = " AND post_folder='$carpeta' AND post_slug = '$post_slug' AND post_visible='Mostrar' ";

        $sql = "SELECT *,DATE_FORMAT(post_date,'%c') as mes,
    ...
    public function GetPostsByTag($tag_slug = null) {
        ...
        $sql = "SELECT *,DATE_FORMAT(post_date,'%b') as mes,
            ...
            DATE_FORMAT(post_date,'%d') as dia
             FROM gnr_post
             WHERE post_folder='es' AND post_visible='Mostrar' $where
             ORDER BY post_date";
    ...
    public function GetTags() {
        ...
        $sql = "SELECT *
             FROM gnr_tag
             WHERE tag_folder='es' AND tag_visible='Mostrar'
    ...
    public function GetCategoriesPost() {
        ...
        $sql = "SELECT *
          ...
          WHERE post_category_folder='es' AND post_category_id IN

          ( SELECT post_category_id FROM gnr_post
          WHERE post_folder='es'  ) ";
    ...
    public function GetPostsByCategory($category_slug = null) {
        ...
        $sql = "SELECT *,DATE_FORMAT(post_date,'%b') as mes,
            ...
            DATE_FORMAT(post_date,'%d') as dia
             ...
             WHERE p.post_folder='es' AND p.post_category_id=c.post_category_id $where
             ORDER BY post_date";
...
//        echo $sql;
    ...
    public function GetPostEx($post_slug = null) {
