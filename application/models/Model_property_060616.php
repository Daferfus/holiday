...
texto.text_title LIKE 'gand%a%'  
*/
	$sql="SELECT   pic.picture_url, lo.location_address, texto.text_title, urls.urls_name, pricing.pricing_price ,pricing.pricing_currency, beds.beds_double_sofa_beds ,  beds.beds_single_sofa_beds , beds.beds_double_beds
FROM property pro, picture pic, location lo, text texto, urls, pricing,beds
WHERE   
pro.property_id = pic.picture_property_id and 
pro.property_id = lo.location_property_id and 
