               ...
               <div class="flex-container">
                                        ...
                                        <div class="hotel-item style-3 bg-white">
                                            <div class="table-view">
                                                <div class="radius-top cell-view">
                                                    ...
                                                    ?>
                                                    <a href="<?php echo $property->urls_name ?>"  rel="nofollow" target="_blank" ><img src="<?php echo $property->picture_url ?>"  alt = ""></a>   
                    ...
                    <aside class="aside aside1 col-xs-12 col-sm-4 col-md-1">
                            ...
                            <div class="sidebar bg-white clearfix">
                                        ...
                                        <div class="search-inputs">
                                            ...
                                            <div class = "form-block clearfix">
                                                <div class="input-style-1 b-50 color-3">
                                                    ...
                                                    <input type="text" placeholder="Fecha de entrada" class="datepicker" name="data_entry"  value="<?php if (!empty($this->session->userdata('data_entry'))) echo $this->session->userdata('data_entry'); ?>" >
                                                </div>
                                            </div>
                                            <div class="form-block clearfix">
                                                <div class="input-style-1 b-50 color-3">
                                                    <img src="<?php echo base_url('assets/webapp'); ?>/img/calendar_icon_grey.png" alt="">
                                                    <input type="text" placeholder="Fecha de salida" class="datepicker" name="data_output" value="<?php if (!empty($this->session->userdata('data_output'))) echo $this->session->userdata('data_output'); ?>" >
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="sidebar-block">
                                    <div class="input-entry color-1">
                                        <a href="http://www.hoteltravel.com/agents/passthrough.asp?affil_id=312286&co=ES&c=MED&lng=en&siteid=1" target="_blank" rel="nofollow">
                                            <img alt="Madrid hotels" border="0" src=" http://res3.hoteltravel.com/images/banner_ads/en/madrid/madrid_200x200.jpg"></a>
                                    </div>
                                </div>
