                ...
                <div class="blog-list">
                    ...
                    foreach ($posts as $post) {
                        ...
                        <div class="blog-list-entry">
                            ...
                            <h4 class="blog-list-title"><a class="color-dark-2 link-dr-blue-2" href="<?php echo site_url('/post/' . $post->post_slug) ?>"><?php echo $post->post_title ?></a></h4>
                            ...
                            <?php foreach ($last_posts as $post) { ?>
                                <div class="hotel-small style-2 clearfix">
                                    <a class="hotel-img black-hover" href="<?php echo site_url('/post/' . $post->post_slug) ?>">
                                        <img class="img-responsive radius-0" src="<?php echo base_url(); ?>assets/uploads/files/<?php echo $post->post_image ?>" alt="">
