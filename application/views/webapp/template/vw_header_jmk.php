...
<html>
    <head>
        ...
        <!--<link href="<?php echo base_url('assets/backoffice'); ?>/css/contacto_style.css" rel="stylesheet"/>-->
        <!--<script src="<?php echo base_url('assets/webapp'); ?>/js/jquery-2.1.4.min.js"></script>-->
        <!--<script src="<?php echo base_url('assets/webapp'); ?>/js/contacto.js"></script>-->
        <script src="<?php echo base_url('assets/ofertas_styles'); ?>/js/jquery.min.js"></script>
        <script src="<?php echo base_url('assets/ofertas_styles'); ?>/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url('assets/ofertas_styles'); ?>/js/jquery.countdown.min.js"></script>
        <script src="<?php echo base_url('assets/ofertas_styles'); ?>/js/wow.js"></script>
        <script src="<?php echo base_url('assets/ofertas_styles'); ?>/js/custom.js"></script>
        <script src="<?php echo base_url('assets/ofertas_styles'); ?>/contactform/contactform.js"></script>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/ofertas_styles'); ?>/css/animate.css">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/ofertas_styles'); ?>/css/style.css">
        ...
        <link rel="shortcut icon" href=<?php echo base_url('assets/ofertas_styles'); ?>"/img/mifavicon.png"/> 
      ...
      <title>Ofertas - HolidayApartment<img alt="alquiler vacacional" src="<?php echo base_url('assets/webapp'); ?>/img/imatgeshome/alquiler-vacacional.jpg"></title>
