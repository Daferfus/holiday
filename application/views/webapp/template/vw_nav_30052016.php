                        ...
                        <nav class="menu">
                            <ul>
                                ...
                                <li class="type-1"><a href="#"><img src="<?php echo base_url('assets/webapp'); ?>/img/logo_user.png" width="18px"/> Tu cuenta<span class="fa fa-angle-down"></span></a>
                                    <ul class="dropmenu">
                                        <li> <a class="c-button b-60 bg-white hv-orange" href="<?php echo base_url(); ?>login"> Entrar</a></li>
                                        <li> <a class="c-button b-60 bg-white hv-orange" href="<?php echo base_url(); ?>register">Darte de alta</a></li>
                                    </ul>
                                </li>  
                                ...
                                <li class="type-1"><a href="<?php echo base_url(); ?>/register_property">Anuncia tu alojamiento<span class="fa fa-angle-down"></span></a></li>


                                <li class="type-1"><a href="<?php echo base_url(); ?>sorteo">Sorteos<span class="fa fa-angle-down"></span></a>
