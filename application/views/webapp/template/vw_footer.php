    ...
    <div class="container" >
        <div class="item flights gal-item col-mob-12 col-xs-12 col-sm-12 reds-socials">
            ...
            <div align="center" class="container">
                <table id="tabla-reds">
                    <tr>
                        <td>
                            <a href="https://www.instagram.com/holidayapartment.online/" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-instagram.JPG" alt="Logo Instagram" width="50px" height="52px" class="instagram"> </a>

                        </td>


                        <td>
                            <a href="https://www.facebook.com/holidayapartme" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-facebook.png" alt="Logo Facebook" width="50px" height="50px" class="facebook"> </a>

                        </td>
                        <td>
                            <a href="https://twitter.com/holidayapartme" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-twitter.png" alt="Logo Twitter" width="50px" height="50px" class="twitter"> </a>

                        </td>
                        <td>
                            <a href="https://plus.google.com/+holidayapartmentonline" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-google+.png" alt="Logo Google +" width="50px" height="50px" class="googleplus"> </a>

                        </td>
                        <td>
                            <a href="https://es.pinterest.com/holidayapar/"target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-pinterest.png" alt="Logo Pinterest" width="50px" height="50px" class="pinterest"> </a>

                        </td>
                        <td>
                            <a href="https://www.youtube.com/c/holidayapartmentonline"target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-youtube.png" alt="Logo Youtube" width="50px" height="50px" class="youtube"></a> 
        ...
        <div>
            ...
            echo $post->post_title
                ...
                <script src="<?php echo base_url('assets/webapp'); ?>/js/jquery.circliful.min.js"></script>
                <script src="<?php echo base_url('assets/webapp'); ?>/js/all.js"></script>
                <script src="<?php echo base_url('assets/webapp'); ?>/js/DateTimePicker.js"></script>
                 
        <script>
        // Traducción al español
        /* he comentado este calendario, he puesto otro en el fichero "vw_header.php"
            $(function ($) {
              ...
              //  var date2 = $('#data_entry').datepicker('getDate', '+1d'); 
              //  $('#data_output').datepicker('setDate', date2);
                //$("#data_output").datepicker().datepicker("setDate", new Date() + getDate() + 2);
            });
            //$("#data_output").datepicker().datepicker("setDate", new Date(2017,1,30));
            $("#data_output").datepicker().datepicker("setDate", new Date() + getDate() + 5);
            */
        </script>
