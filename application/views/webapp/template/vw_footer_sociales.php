...
<div class="item flights gal-item col-mob-12 col-xs-12 col-sm-12 reds-socials">
    ...
    <div align="center" class="container">
        <table id="tabla-reds">
            <tr>
                <td>
                    <a href="https://www.instagram.com/holidayapartment.online/" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-instagram.JPG" alt=""  class="instagram"> </a>

                </td>


                <td>
                    <a href="https://www.facebook.com/holidayapartme" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-facebook.png" alt=""  class="facebook"> </a>

                </td>
                <td>
                    <a href="https://twitter.com/holidayapartme" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-twitter.png" alt=""  class="twitter"> </a>

                </td>
                <td>
                    <a href="https://plus.google.com/+holidayapartmentonline" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-google+.png" alt=""  class="googleplus"> </a>

                </td>
                <td>
                    <a href="https://es.pinterest.com/holidayapar/"target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-pinterest.png" alt=""  class="pinterest"> </a>

                </td>
                <td>
                    <a href="https://www.youtube.com/c/holidayapartmentonline"target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-youtube.png" alt="" class="youtube"></a> 
