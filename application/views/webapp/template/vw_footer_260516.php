    ...
    <div align="center">
        <table id="tabla-reds">
            <tr>
                ...
                <td>
                    <a href="https://www.facebook.com/Holidayapartment-113256929085345" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-facebook.png" alt="" width="50px" height="50px" class="facebook"> </a>

                </td>
                <td>
                    <a href="https://twitter.com/holiapartment" target="_blank"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-twitter.png" alt="" width="50px" height="50px" class="twitter"> </a>
...
<!--        <p>
        ...
        <a href="https://www.facebook.com/holiapartment"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-facebook.png" alt="" width="50px" height="50px" class="facebook"> </a>
        <a href="https://twitter.com/holiapartment"> <img src="<?php echo base_url('assets/webapp'); ?>/img/reds-socials/logo-twitter.png" alt="" width="50px" height="50px" class="twitter"> </a>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-sm-6 no-padding">
                <div class="footer-block">
                    <div class="f_news clearfix">
                        ...
                        <h4> <a href="#" class="enlaces-naranja">Contactanos</a> </h4>
                    </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="footer-block">
                    ...
                    <h4> <a href="#" class="enlaces-naranja"><img src="<?php echo base_url('assets/webapp'); ?>/img/airplane-flight.png" width="19px"/> Precios vuelos avión</a> </h4>
                    <h4> <a href="#" class="enlaces-naranja"><img src="<?php echo base_url('assets/webapp'); ?>/img/volkswagen-car-side-view.png" width="19px"/> Alquiler vehiculos</a> </h4>
