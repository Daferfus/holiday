    ...
    <body data-color="theme-1">
        ...
        <div class="style-page">
            <div class="wrappers">
                ...
                <a href="index.html" class="site-logo"><img src="<?php echo base_url('assets/webapp'); ?>/img/theme-1/logo_dark.png" alt=""></a>
                ...
                <div class="color-block">
                    ...
                    <div class="header-style"> 
                        <a href="menu_style_1.html" class="active">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/header_1.png" alt="">
                        </a>
                        <a href="menu_style_2.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/header_2.png" alt="">
                        </a>
                        <a href="menu_style_3.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/header_3.png" alt="">
                        </a>
                        <a href="menu_style_4.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/header_4.png" alt="">
                        </a>
                        <a href="menu_style_5.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/header_5.png" alt="">
                        </a>
                        <a href="menu_style_6.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/header_6.png" alt="">
                        </a>
                    </div>  
                </div>
                <div class="color-block">
                    ...
                    <div class="header-style"> 
                        <a href="footer_style_1.html" class="active">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/footer_1.png" alt="">
                        </a>
                        <a href="footer_style_2.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/footer_2.png" alt="">
                        </a>
                        <a href="footer_style_3.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/footer_3.png" alt="">
                        </a>
                        <a href="footer_style_4.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/footer_4.png" alt="">
                        </a>
                        <a href="footer_style_5.html">
                            <img src="<?php echo base_url('assets/webapp'); ?>/img/landing/footer_5.png" alt="">
                        </a>
                    </div>  
                </div>
            </div> 
                    ...
                    <div class="col-md-12">
                        <div class="nav"> 
                            <a href="index.html" class="logo">
                                <img src="<?php echo base_url('assets/webapp'); ?>/img/theme-1/logo_dark.png" alt="lets travel">
                            </a>
                            ...
                            <nav class="menu">
                                <ul>
                                    ...
                                    <li class="type-1 active"><a href="#">Hotels<span class="fa fa-angle-down"></span></a>
                                        <ul class="dropmenu">
        ...
        <div class="inner-banner">
            <img class="center-image" src="<?php echo base_url('assets/webapp'); ?>/img/tour_list/inner_banner_1.jpg" alt="">
                                        ...
                                        <div class = "hotel-item style-3 bg-white">
                                            <div class = "table-view">
                                                <div class = "radius-top cell-view">
                                                    ...
                                                    <img src = "<?php echo $property->picture_url ?>" width="50px" height="50" alt = "">
                                                ...
                                                <div class = "title hotel-middle clearfix cell-view">
                                                    ...
                                                    <p class = "f-14 grid-hidden"><?php echo $property->text_description ?></p>
                                                </div>
                ...
                <div class = "container">
                    <div class = "row">
                        <div class = "col-md-12">
                            <div class = "copyright">
                                <span>&copy;
                                    2015 All rights reserved. LET'STRAVEL</span>
                            </div>
                            <ul>
