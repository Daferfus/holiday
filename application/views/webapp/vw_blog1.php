<style>
    ...
    #botones-para-compartir{text-align:left;}.likedino:hover, .facebooko:hover, .twittero:hover, .googleo:hover,.instagram:hover {-webkit-transform: rotate(360deg);-moz-transform: rotate(360deg);transform: rotate(360deg);transition:all .3s ease-out;-moz-transition: all .5s;-webkit-transition: all .5s;-o-transition: all .5s;}.likedino, .facebooko, .twittero, .googleo, .instagram {transition:all .3s ease-out;-moz-transition: all .5s;-webkit-transition: all .5s;-o-transition: all .5s;margin-left:10px; /* espacio entre cada boton */}
...
<td>
                                ...
                                <a href="javascript:void(0);" onclick="window.open(&quot;https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Fholidayapartment.online%2Fblog&ref_src=twsrc%5Etfw&text=Alquiler%20vacacional%20-%20Buscador%20de%20alojamientos%20para%20vacaciones&tw_p=tweetbutton&url=https%3A%2F%2Fholidayapartment.online%2Fblog&quot;,&quot;gplusshare&quot;,&quot;toolbar=0,status=0,width=548,height=325&quot;);" rel="nofollow" title="Compartir en Google+"><img alt="compartir en twitter" class="twittero" height="40" src="http://4.bp.blogspot.com/-gqVyoE8cVME/ViFsO009lbI/AAAAAAAABwo/1oK8cUnY36Q/s1600/twitter-long.png" title="compartir en twitter" width="40" /></a>                                </td>
                                </tr>
                                </table>
                            </div>
                        </div>
