...
<body data-color="theme-1">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="sidebar bg-white clearfix">
                        ...
                        <!--                        <div class="sidebar-block">
                                                    <h4 class="sidebar-title color-dark-2">Pincha aquí y mira</h4>
                                                    <ul class="sidebar-category color-1">
                                                        <li class="active">
                                                            <a class="cat-drop" href="#">Vuelos ver precio <span class="fr"></span></a>
                                                            <ul>
                                                                <li><a href="#">Vuelos (785)</a></li>
                                                                <li><a href="#">Vuelos (85)</a></li>
                                                        ...
                                                        <li>
                                                            <a class="cat-drop" href="#">Alquiler de vehículos ver precio <span class="fr"></span></a>
                                                            <ul>
                                                        ...
                                                        <li>
                                                            <a class="cat-drop" href="#">Alojarse en hoteles ver precios<span class="fr"></span></a>
                                                            <ul>
                                                                <li><a href="#">sea tours (785)</a></li>
                                                                <li><a href="#">food tours (85)</a></li>
                                                                <li><a href="#">romantic tours (125)</a></li>
                                                        ...
                                                        <li>
                                                            <a class="cat-drop" href="#">Alojarse en hostales ver precio<span class="fr"></span></a>
                                                            <ul>
                                                                <li><a href="#">sea tours (785)</a></li>
                                                                <li><a href="#">food tours (85)</a></li>
                                                                <li><a href="#">romantic tours (125)</a></li>
    ...
    <!--                                <div class="input-entry color-1">
						...
						<div class="input-entry color-1">
								...
								<a href="http://www.booking.com?aid=1143346" rel="nofollow"  >Booking.com</a>
								</ins>
...
<img src="http://ad.zanox.com/ppv/?38116541C1110369904" align="bottom" width="1" height="1" border="0" hspace="1"><!DOCTYPE html>
<html>

<head>
    <meta name="GCD" content="YTk3ODQ3ZWZhN2I4NzZmMzBkNTEwYjJlc62bf8081b3c068f50c0dbe7102cf842" />
    ...
    <meta data-template-name="gwd-AdMob_Standard_Banner_Static_300x250_v1_0">
    ...
    <style data-exports-type="gwd-pagedeck" data-gwd-node="true" type="text/css">
        .gwd-pagedeck {
            position: relative
        }
    ...
    <style data-exports-type="gwd-page" data-gwd-node="true" type="text/css">
        .gwd-inactive {
            visibility: hidden
        }
    </style>
    <style data-exports-type="gwd-doubleclick" data-gwd-node="true" type="text/css">
        div[is=gwd-page].fs,
        div[is=gwd-page].fs>div.gwd-page-content {
            width: 100%;
            height: 100%;
            border: none
        }
    </style>
    <style data-exports-type="gwd-taparea" data-gwd-node="true" type="text/css">
        gwd-taparea {
            display: block;
            cursor: pointer;
    ...
    <style data-exports-type="gwd-image" data-gwd-node="true" type="text/css">
    ...
    <style type="text/css">
        ...
        .gwd-div-b1kl {
            ...
            left: 16px;
            top: 71px;
            transform-origin: 87px 22px 0px;
            -webkit-transform-origin: 87px 22px 0px;
            -moz-transform-origin: 87px 22px 0px;
            text-align: center;
            width: 141.01px;
            line-height: 24px;
            transform-style: preserve-3d;
            -webkit-transform-style: preserve-3d;
            -moz-transform-style: preserve-3d;
            transform: translate3d(-189.024px, -41px, 0);
            -webkit-transform: translate3d(-189.024px, -41px, 0);
            -moz-transform: translate3d(-189.024px, -41px, 0);
            opacity: 1;
            height: 47px;
            background-image: none
        }
        ...
        .gwd-div-1ojk {
            ...
            font-weight: bold;
            color: #fff;
            transform-origin: 86px -51px 0;
            -webkit-transform-origin: 86px -51px 0;
            -moz-transform-origin: 86px -51px 0;
            left: -275px;
            top: 71px;
            text-align: center;
            line-height: 20px;
            ...
            -webkit-transform-style: preserve-3d;
            -moz-transform-style: preserve-3d;
            transform: translate3d(120px, -41px, 0);
            -webkit-transform: translate3d(120px, -41px, 0);
            -moz-transform: translate3d(120px, -41px, 0);
            width: 130px;
            height: 147px
        }
        ...
        .gwd-img-ivw6 {
            ...
            -webkit-transform-style: preserve-3d;
            -moz-transform-style: preserve-3d;
            transform: translate3d(168px, -85px, 0);
            -webkit-transform: translate3d(168px, -85px, 0);
            -moz-transform: translate3d(168px, -85px, 0);
            background-image: none
        }
        ...
        .gwd-span-1ku0 {
            ...
            color: #000;
            text-align: center;
            transform-origin: 117.672px 14.5px 0px;
            -webkit-transform-origin: 117.672px 14.5px 0px;
            -moz-transform-origin: 117.672px 14.5px 0px;
            left: 0px;
            top: 295px;
            transform-style: preserve-3d;
            -webkit-transform-style: preserve-3d;
            -moz-transform-style: preserve-3d;
            transform: translate3d(-162px, -265px, 0);
            -webkit-transform: translate3d(-162px, -265px, 0);
            -moz-transform: translate3d(-162px, -265px, 0);
            height: 80px;
            width: 125px;
            font-size: 16px
        }
        ...
        .gwd-img-5n1j {
            ...
            -moz-transform: translate3d(30px, -1px, 0)
        }
        ...
        .gwd-span-1ohi {
            ...
            border-color: transparent;
            border-radius: 4px;
            transform-origin: 95.672px -217.5px 0;
            -webkit-transform-origin: 95.672px -217.5px 0;
            -moz-transform-origin: 95.672px -217.5px 0;
            left: 41px;
            top: 278px;
            font-weight: bold;
            padding-top: 12px;
            width: 128px;
            height: 48px;
            transform: translate3d(-25px, -363.661px, 0);
            -webkit-transform: translate3d(-25px, -363.661px, 0);
            -moz-transform: translate3d(-25px, -363.661px, 0);
            transform-style: preserve-3d;
            -webkit-transform-style: preserve-3d;
            -moz-transform-style: preserve-3d;
            background: -webkit-linear-gradient(top, #fd9225 0, #ca5a18 100%);
            background: -moz-linear-gradient(top, #fd9225 0, #ca5a18 100%);
            background: linear-gradient(to bottom, #fd9225 0, #ca5a18 100%)
        }
        ...
        .gwd-canvas-j6bx {
            ...
            -webkit-transform-style: preserve-3d;
            -moz-transform-style: preserve-3d;
            transform: translate3d(171px, 11px, 0);
            -webkit-transform: translate3d(171px, 11px, 0);
            -moz-transform: translate3d(171px, 11px, 0)
        }
        ...
        .gwd-span-1whg {
            ...
            width: 0px;
            height: 0px;
            transform-origin: -17px -6px 0;
            -webkit-transform-origin: -17px -6px 0;
            -moz-transform-origin: -17px -6px 0
        }
        ...
        .gwd-span-1e1e {
            ...
            font-family: Arial;
            font-weight: bold;
            transform-origin: 127.234px 39.6406px 0px;
            -webkit-transform-origin: 127.234px 39.6406px 0px;
            -moz-transform-origin: 127.234px 39.6406px 0px;
            left: 19px;
            top: 147px;
            border-image-source: none;
            text-align: left;
            ...
            -webkit-transform-style: preserve-3d;
            -moz-transform-style: preserve-3d;
            transform: translate3d(171px, -4px, 0);
            -webkit-transform: translate3d(171px, -4px, 0);
            -moz-transform: translate3d(171px, -4px, 0);
            width: 111px
        }
        ...
        #page1.gwd-play-animation .gwd-gen-oxzogwdanimation {
            animation: gwd-gen-oxzogwdanimation_gwd-keyframes 3.464s linear 3.957s 1 normal forwards;
            -webkit-animation: gwd-gen-oxzogwdanimation_gwd-keyframes 3.464s linear 3.957s 1 normal forwards;
            -moz-animation: gwd-gen-oxzogwdanimation_gwd-keyframes 3.464s linear 3.957s 1 normal forwards
        }
        
        #page1.gwd-play-animation .gwd-gen-1dltgwdanimation {
            animation: gwd-gen-1dltgwdanimation_gwd-keyframes 5.45s linear 7.419s 1 normal forwards;
            -webkit-animation: gwd-gen-1dltgwdanimation_gwd-keyframes 5.45s linear 7.419s 1 normal forwards;
            -moz-animation: gwd-gen-1dltgwdanimation_gwd-keyframes 5.45s linear 7.419s 1 normal forwards
        }
        
        #page1.gwd-play-animation .gwd-gen-1wi2gwdanimation {
            animation: gwd-gen-1wi2gwdanimation_gwd-keyframes 4.4s linear 0s 1 normal forwards;
            -webkit-animation: gwd-gen-1wi2gwdanimation_gwd-keyframes 4.4s linear 0s 1 normal forwards;
            -moz-animation: gwd-gen-1wi2gwdanimation_gwd-keyframes 4.4s linear 0s 1 normal forwards
        }
        
        #page1.gwd-play-animation .gwd-gen-1mk0gwdanimation {
            animation: gwd-gen-1mk0gwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -webkit-animation: gwd-gen-1mk0gwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -moz-animation: gwd-gen-1mk0gwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards
        }
        
        #page1.gwd-play-animation .gwd-gen-o2rngwdanimation {
            animation: gwd-gen-o2rngwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -webkit-animation: gwd-gen-o2rngwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -moz-animation: gwd-gen-o2rngwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards
        }
        
        #page1.gwd-play-animation .gwd-gen-fbafgwdanimation {
            animation: gwd-gen-fbafgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -webkit-animation: gwd-gen-fbafgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -moz-animation: gwd-gen-fbafgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards
        }
        
        #page1.gwd-play-animation .gwd-gen-q02tgwdanimation {
            animation: gwd-gen-q02tgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -webkit-animation: gwd-gen-q02tgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -moz-animation: gwd-gen-q02tgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards
        }
        
        #page1.gwd-play-animation .gwd-gen-1njzgwdanimation {
            animation: gwd-gen-1njzgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -webkit-animation: gwd-gen-1njzgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards;
            -moz-animation: gwd-gen-1njzgwdanimation_gwd-keyframes 12.1s linear 0s 1 normal forwards
        }
        
        @keyframes gwd-gen-1njzgwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(0, 0, 0);
        ...
        @-webkit-keyframes gwd-gen-1njzgwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(0, 0, 0);
        ...
        @-moz-keyframes gwd-gen-1njzgwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(0, 0, 0);
            ...
            63.64% {
                -moz-transform: translate3d(-166px, 0, 0);
                -moz-animation-timing-function: linear
            }
            96.69% {
                -moz-transform: translate3d(-166px, 0, 0);
        ...
        @keyframes gwd-gen-q02tgwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(30px, -1px, 0);
                animation-timing-function: linear
            }
            ...
            63.64% {
                transform: translate3d(-137px, 8px, 0);
                animation-timing-function: linear
            }
            96.69% {
                transform: translate3d(-137px, 8px, 0);
            ...
            100% {
                transform: translate3d(43px, 8px, 0);
                animation-timing-function: linear
            }
        }
        
        @-webkit-keyframes gwd-gen-q02tgwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(30px, -1px, 0);
                -webkit-animation-timing-function: linear
            }
            ...
            63.64% {
                -webkit-transform: translate3d(-137px, 8px, 0);
                -webkit-animation-timing-function: linear
            }
            96.69% {
                -webkit-transform: translate3d(-137px, 8px, 0);
            ...
            100% {
                -webkit-transform: translate3d(43px, 8px, 0);
                -webkit-animation-timing-function: linear
            }
        }
        
        @-moz-keyframes gwd-gen-q02tgwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(30px, -1px, 0);
                -moz-animation-timing-function: linear
            }
            ...
            63.64% {
                -moz-transform: translate3d(-137px, 8px, 0);
                -moz-animation-timing-function: linear
            }
            96.69% {
                -moz-transform: translate3d(-137px, 8px, 0);
            ...
            100% {
                -moz-transform: translate3d(43px, 8px, 0);
                -moz-animation-timing-function: linear
            }
        }
        
        @keyframes gwd-gen-fbafgwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(168px, -85px, 0);
                animation-timing-function: linear
            }
            ...
            63.64% {
                transform: translate3d(1px, -76px, 0);
                animation-timing-function: linear
            }
            96.69% {
                transform: translate3d(1px, -76px, 0);
            ...
            100% {
                transform: translate3d(181px, -76px, 0);
                animation-timing-function: linear
            }
        }
        
        @-webkit-keyframes gwd-gen-fbafgwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(168px, -85px, 0);
                -webkit-animation-timing-function: linear
            }
            ...
            63.64% {
                -webkit-transform: translate3d(1px, -76px, 0);
                -webkit-animation-timing-function: linear
            }
            96.69% {
                -webkit-transform: translate3d(1px, -76px, 0);
            ...
            100% {
                -webkit-transform: translate3d(181px, -76px, 0);
                -webkit-animation-timing-function: linear
            }
        }
        
        @-moz-keyframes gwd-gen-fbafgwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(168px, -85px, 0);
                -moz-animation-timing-function: linear
            }
            ...
            63.64% {
                -moz-transform: translate3d(1px, -76px, 0);
                -moz-animation-timing-function: linear
            }
            96.69% {
                -moz-transform: translate3d(1px, -76px, 0);
            ...
            100% {
                -moz-transform: translate3d(181px, -76px, 0);
                -moz-animation-timing-function: linear
            }
        }
        
        @keyframes gwd-gen-o2rngwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(171px, 11px, 0);
                animation-timing-function: linear
            }
            ...
            100% {
                transform: translate3d(185px, 11px, 0);
                animation-timing-function: linear
            }
        }
        
        @-webkit-keyframes gwd-gen-o2rngwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(171px, 11px, 0);
                -webkit-animation-timing-function: linear
            }
            ...
            100% {
                -webkit-transform: translate3d(185px, 11px, 0);
                -webkit-animation-timing-function: linear
            }
        }
        
        @-moz-keyframes gwd-gen-o2rngwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(171px, 11px, 0);
                -moz-animation-timing-function: linear
            }
            ...
            100% {
                -moz-transform: translate3d(185px, 11px, 0);
                -moz-animation-timing-function: linear
            }
        }
        ...
        @keyframes gwd-gen-1wi2gwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(-186px, -41px, 0);
                opacity: 0.82;
                height: 131px;
                animation-timing-function: linear
            }
            13.5% {
                transform: translate3d(-6px, -41px, 0);
                opacity: 1;
                height: 71px;
                animation-timing-function: linear
            }
            ...
            79.3% {
                transform: translate3d(-12px, -41px, 0);
                opacity: 1;
                height: 47px;
                animation-timing-function: linear
            }
            88.64% {
                transform: translate3d(-3px, -41px, 0);
                opacity: 1;
                height: 47px;
                animation-timing-function: linear
            }
        ...
        @-webkit-keyframes gwd-gen-1wi2gwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(-186px, -41px, 0);
                opacity: 0.82;
                height: 131px;
                -webkit-animation-timing-function: linear
            }
            13.5% {
                -webkit-transform: translate3d(-6px, -41px, 0);
                opacity: 1;
                height: 71px;
                -webkit-animation-timing-function: linear
            }
            31.82% {
                -webkit-transform: translate3d(-15px, -41px, 0);
                opacity: 1;
                height: 70.7344px;
                -webkit-animation-timing-function: linear
            }
            ...
            52.27% {
                -webkit-transform: translate3d(-11px, -41px, 0);
                -webkit-animation-timing-function: linear
            }
            68.48% {
                -webkit-transform: translate3d(0, -41px, 0);
            ...
            79.3% {
                -webkit-transform: translate3d(-12px, -41px, 0);
                opacity: 1;
                height: 47px;
                -webkit-animation-timing-function: linear
            }
            88.64% {
                -webkit-transform: translate3d(-3px, -41px, 0);
                opacity: 1;
                height: 47px;
                -webkit-animation-timing-function: linear
            }
        ...
        @-moz-keyframes gwd-gen-1wi2gwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(-186px, -41px, 0);
                opacity: 0.82;
                height: 131px;
                -moz-animation-timing-function: linear
            }
            13.5% {
                -moz-transform: translate3d(-6px, -41px, 0);
                opacity: 1;
                height: 71px;
                -moz-animation-timing-function: linear
            }
            31.82% {
                -moz-transform: translate3d(-15px, -41px, 0);
                opacity: 1;
                height: 70.7344px;
                -moz-animation-timing-function: linear
            }
            ...
            52.27% {
                -moz-transform: translate3d(-11px, -41px, 0);
                -moz-animation-timing-function: linear
            }
            68.48% {
                -moz-transform: translate3d(0, -41px, 0);
            ...
            79.3% {
                -moz-transform: translate3d(-12px, -41px, 0);
                opacity: 1;
                height: 47px;
                -moz-animation-timing-function: linear
            }
            88.64% {
                -moz-transform: translate3d(-3px, -41px, 0);
                opacity: 1;
                height: 47px;
                -moz-animation-timing-function: linear
            }
        ...
        @keyframes gwd-gen-oxzogwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(120px, -41px, 0);
                width: 130px;
                height: 147px;
            ...
            12.47% {
                transform: translate3d(293px, -41px, 0);
                width: 124px;
                height: 117px;
                animation-timing-function: linear
            }
            28.12% {
                transform: translate3d(286px, -41px, 0);
                width: 124px;
                height: 116px;
                animation-timing-function: linear
            }
            53.58% {
                transform: translate3d(301px, -41px, 0);
                width: 124px;
                height: 118px;
                animation-timing-function: linear
            }
            ...
            87.85% {
                transform: translate3d(297px, -41px, 0);
                width: 123.78px;
                height: 115px;
                animation-timing-function: linear
            }
            100% {
                transform: translate3d(83px, -41px, 0);
                width: 124px;
                height: 110px;
                animation-timing-function: linear
            }
        ...
        @-webkit-keyframes gwd-gen-oxzogwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(120px, -41px, 0);
                width: 130px;
                height: 147px;
            ...
            12.47% {
                -webkit-transform: translate3d(293px, -41px, 0);
                width: 124px;
                height: 117px;
                -webkit-animation-timing-function: linear
            }
            28.12% {
                -webkit-transform: translate3d(286px, -41px, 0);
                width: 124px;
                height: 116px;
                -webkit-animation-timing-function: linear
            }
            53.58% {
                -webkit-transform: translate3d(301px, -41px, 0);
                width: 124px;
                height: 118px;
                -webkit-animation-timing-function: linear
            }
            ...
            87.85% {
                -webkit-transform: translate3d(297px, -41px, 0);
                width: 123.78px;
                height: 115px;
                -webkit-animation-timing-function: linear
            }
            100% {
                -webkit-transform: translate3d(83px, -41px, 0);
                width: 124px;
                height: 110px;
                -webkit-animation-timing-function: linear
            }
        ...
        @-moz-keyframes gwd-gen-oxzogwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(120px, -41px, 0);
                width: 130px;
                height: 147px;
            ...
            12.47% {
                -moz-transform: translate3d(293px, -41px, 0);
                width: 124px;
                height: 117px;
                -moz-animation-timing-function: linear
            }
            28.12% {
                -moz-transform: translate3d(286px, -41px, 0);
                width: 124px;
                height: 116px;
                -moz-animation-timing-function: linear
            }
            53.58% {
                -moz-transform: translate3d(301px, -41px, 0);
                width: 124px;
                height: 118px;
                -moz-animation-timing-function: linear
            }
            ...
            87.85% {
                -moz-transform: translate3d(297px, -41px, 0);
                width: 123.78px;
                height: 115px;
                -moz-animation-timing-function: linear
            }
            100% {
                -moz-transform: translate3d(83px, -41px, 0);
                width: 124px;
                height: 110px;
                -moz-animation-timing-function: linear
            }
        ...
        @keyframes gwd-gen-1dltgwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(-162px, -265px, 0);
                height: 80px;
                width: 125px;
            ...
            3.56% {
                transform: translate3d(18px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                animation-timing-function: linear
            ...
            6.99% {
                transform: translate3d(19px, -265px, 0);
                font-size: 20px;
                animation-timing-function: linear
            }
            24.22% {
                transform: translate3d(26px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                animation-timing-function: linear
            ...
            41.17% {
                transform: translate3d(12px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                animation-timing-function: linear
            ...
            60.86% {
                transform: translate3d(27px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                animation-timing-function: linear
            ...
            76.72% {
                transform: translate3d(10px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                animation-timing-function: linear
            ...
            93.23% {
                transform: translate3d(25px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                animation-timing-function: linear
            ...
            100% {
                transform: translate3d(-260px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                animation-timing-function: linear
        ...
        @-webkit-keyframes gwd-gen-1dltgwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(-162px, -265px, 0);
                height: 80px;
                width: 125px;
            ...
            3.56% {
                -webkit-transform: translate3d(18px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -webkit-animation-timing-function: linear
            ...
            6.99% {
                -webkit-transform: translate3d(19px, -265px, 0);
                font-size: 20px;
                -webkit-animation-timing-function: linear
            }
            24.22% {
                -webkit-transform: translate3d(26px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -webkit-animation-timing-function: linear
            ...
            41.17% {
                -webkit-transform: translate3d(12px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -webkit-animation-timing-function: linear
            ...
            60.86% {
                -webkit-transform: translate3d(27px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -webkit-animation-timing-function: linear
            ...
            76.72% {
                -webkit-transform: translate3d(10px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -webkit-animation-timing-function: linear
            ...
            93.23% {
                -webkit-transform: translate3d(25px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -webkit-animation-timing-function: linear
            ...
            100% {
                -webkit-transform: translate3d(-260px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -webkit-animation-timing-function: linear
        ...
        @-moz-keyframes gwd-gen-1dltgwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(-162px, -265px, 0);
                height: 80px;
                width: 125px;
            ...
            3.56% {
                -moz-transform: translate3d(18px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -moz-animation-timing-function: linear
            ...
            6.99% {
                -moz-transform: translate3d(19px, -265px, 0);
                font-size: 20px;
                -moz-animation-timing-function: linear
            }
            24.22% {
                -moz-transform: translate3d(26px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -moz-animation-timing-function: linear
            ...
            41.17% {
                -moz-transform: translate3d(12px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -moz-animation-timing-function: linear
            ...
            60.86% {
                -moz-transform: translate3d(27px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -moz-animation-timing-function: linear
            ...
            76.72% {
                -moz-transform: translate3d(10px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -moz-animation-timing-function: linear
            ...
            93.23% {
                -moz-transform: translate3d(25px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -moz-animation-timing-function: linear
            ...
            100% {
                -moz-transform: translate3d(-260px, -265px, 0);
                height: 80px;
                width: 125px;
                font-size: 16px;
                -moz-animation-timing-function: linear
        ...
        @keyframes gwd-gen-1mk0gwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(171px, -4px, 0);
                width: 117px;
                animation-timing-function: linear
            ...
            100% {
                transform: translate3d(185px, -4px, 0);
                width: 112px;
                animation-timing-function: linear
            }
        }
        
        @-webkit-keyframes gwd-gen-1mk0gwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(171px, -4px, 0);
                width: 117px;
                -webkit-animation-timing-function: linear
            ...
            100% {
                -webkit-transform: translate3d(185px, -4px, 0);
                width: 112px;
                -webkit-animation-timing-function: linear
            }
        }
        
        @-moz-keyframes gwd-gen-1mk0gwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(171px, -4px, 0);
                width: 117px;
                -moz-animation-timing-function: linear
            ...
            100% {
                -moz-transform: translate3d(185px, -4px, 0);
                width: 112px;
                -moz-animation-timing-function: linear
            }
        }
        
        #page1.gwd-play-animation .gwd-gen-1n2hgwdanimation {
            animation: gwd-gen-1n2hgwdanimation_gwd-keyframes 2.5s linear 12.5s 1 normal forwards;
            -webkit-animation: gwd-gen-1n2hgwdanimation_gwd-keyframes 2.5s linear 12.5s 1 normal forwards;
            -moz-animation: gwd-gen-1n2hgwdanimation_gwd-keyframes 2.5s linear 12.5s 1 normal forwards
        }
        
        @keyframes gwd-gen-1n2hgwdanimation_gwd-keyframes {
            0% {
                transform: translate3d(-25px, -363.661px, 0);
                width: 128px;
                height: 48px;
            ...
            8% {
                transform: translate3d(-28px, -198.888px, 0);
                width: 134.391px;
                height: 46.625px;
                animation-timing-function: linear;
                background: -webkit-linear-gradient(top, #fd9225 0, #ca5a18 100%)
            ...
            12% {
                transform: translate3d(-28px, -188.888px, 0);
                width: 134.391px;
                height: 46.625px;
                animation-timing-function: linear;
                background: -webkit-linear-gradient(top, #fd9225 0, #ca5a18 100%)
        ...
        @-webkit-keyframes gwd-gen-1n2hgwdanimation_gwd-keyframes {
            0% {
                -webkit-transform: translate3d(-25px, -363.661px, 0);
                width: 128px;
                height: 48px;
                -webkit-animation-timing-function: linear;
                background-image: -webkit-linear-gradient(top, #fd9225 0, #ca5a18 100%)
            }
            8% {
                -webkit-transform: translate3d(-28px, -198.888px, 0);
                width: 134.391px;
                height: 46.625px;
                -webkit-animation-timing-function: linear;
                background-image: -webkit-linear-gradient(top, #fd9225 0, #ca5a18 100%)
            ...
            12% {
                -webkit-transform: translate3d(-28px, -188.888px, 0);
                width: 134.391px;
                height: 46.625px;
                -webkit-animation-timing-function: linear;
                background-image: -webkit-linear-gradient(top, #fd9225 0, #ca5a18 100%)
        ...
        @-moz-keyframes gwd-gen-1n2hgwdanimation_gwd-keyframes {
            0% {
                -moz-transform: translate3d(-25px, -363.661px, 0);
                width: 128px;
                height: 48px;
            ...
            8% {
                -moz-transform: translate3d(-28px, -198.888px, 0);
                width: 134.391px;
                height: 46.625px;
                -moz-animation-timing-function: linear;
                background-image: -webkit-linear-gradient(top, #fd9225 0, #ca5a18 100%)
            ...
            12% {
                -moz-transform: translate3d(-28px, -188.888px, 0);
                width: 134.391px;
                height: 46.625px;
                -moz-animation-timing-function: linear;
                background-image: -webkit-linear-gradient(top, #fd9225 0, #ca5a18 100%)
    ...
    <script data-source="googbase_min.js" data-version="3" data-exports-type="googbase" type="text/javascript">
        + function() {
    ...
    <script data-source="gwd_webcomponents_min.js" data-version="4" data-exports-type="gwd_webcomponents" type="text/javascript">
        ...
        "undefined" == typeof WeakMap && ! function() {
            ...
            function(e) {
                ...
                if (!e.JsMutationObserver) {
                    var h, v = new WeakMap;
                    if (/Trident|Edge/.test(navigator.userAgent)) h = setTimeout;
                    else if (window.setImmediate) h = window.setImmediate;
                    else {
                        var w = [],
            ...
            function(e) {
                ...
                function v(e) {
                    ...
                    t(e, n), h(e), g.dom && console.groupEnd()
                }
                ...
                }), e.watchShadow = f, e.upgradeDocumentTree = w, e.upgradeDocument = v, e.upgradeSubtree = o, e.upgradeAll = t, e.attached = a, e.takeRecords = m
            }), window.CustomElements.addModule(function(e) {
                function t(t, o) {
                ...
                function t(t, o) {
                    var s = o || {};
                    if (!t) throw new Error("document.registerElement: first argument &grave;name&grave; must not be empty");
                    ...
                    return s.prototype || (s.prototype = Object.create(HTMLElement.prototype)), s.__name = t.toLowerCase(), s.lifecycle = s.lifecycle || {}, s.ancestry = i(s["extends"]), a(s), d(s), n(s.prototype), c(s.__name, s), s.ctor = l(s), s.ctor.prototype = s.prototype, s.prototype.constructor = s.ctor, e.ready && w(document), s.ctor
                }
                ...
                function p(e, t) {
                    ...
                    var o;
                    return t ? (o = p(e), o.setAttribute("is", t), o) : (o = O(e), e.indexOf("-") >= 0 && _(o, HTMLElement), o)
                }
                ...
                h = Object.__proto__ || E ? function(e, t) {
                    ...
                    return !1
                }, m(Node.prototype, "cloneNode"), m(document, "importNode"), v && ! function() {
                ...
                }(), document.registerElement = t, document.createElement = p, document.createElementNS = f, e.registry = N, e["instanceof"] = h, e.reservedTagList = y, e.getRegisteredDefinition = u, document.register = document.registerElement
            }),
            function(e) {
                function t() {
                ...
                if (window.wrap || (window.ShadowDOMPolyfill ? (window.wrap = window.ShadowDOMPolyfill.wrapIfNeeded, window.unwrap = window.ShadowDOMPolyfill.unwrapIfNeeded) : window.wrap = window.unwrap = function(e) {
                        ...
                        e["import"] && d(wrap(e["import"]))
                    }), (!window.CustomEvent || r && "function" != typeof window.CustomEvent) && (window.CustomEvent = function(e, t) {
                        t = t || {};
                    ...
                    }, window.CustomEvent.prototype = window.Event.prototype), "complete" === document.readyState || e.flags.eager) t();
        ...
        "undefined" == typeof window.CustomEvent && (window.CustomEvent = function(c, a) {
            a = a || {};
            var b = document.createEvent("CustomEvent");
            b.initCustomEvent(c, Boolean(a.bubbles), Boolean(a.cancelable), a.detail);
            return b
        }, window.CustomEvent.prototype = window.Event.prototype);
        "undefined" == typeof document.register && (document.register = function() {
            return document.registerElement.apply(document, arguments)
        });
    </script>
    <script data-source="gwdpage_min.js" data-version="8" data-exports-type="gwd-page" type="text/javascript">
        - function() {
            "use strict";
            var b;
            var c = function(a) {
            ...
            var f = function() {};
            goog.inherits(f, HTMLDivElement);
            b = f.prototype;
            ...
            f.prototype.gwdPresent = function() {
                d("pagepresenting", this);
                this.classList.add("gwd-play-animation")
            };
            f.prototype.isPortrait = function() {
                return this.j
            };
    ...
    <script data-source="gwdpagedeck_min.js" data-version="8" data-exports-type="gwd-pagedeck" type="text/javascript">
        - function() {
            "use strict";
            var g;
            var l = ["-ms-", "-moz-", "-webkit-", ""],
            ...
            var u = function(a, c, b) {
                    var d;
                    b ? (d = document.createEvent("CustomEvent"), d.initCustomEvent(a, !0, !0, b)) : (d = document.createEvent("Event"), d.initEvent(a, !0, !0));
                    c.dispatchEvent(d)
                },
                w = function(a, c) {
                    var b = function(d) {
            ...
            x.prototype.attachedCallback = function() {
                if (!this.B) {
                    ...
                    var b = this.offsetHeight,
                        c = (c && "#") + c + ".gwd-pagedeck > .gwd-page";
                    a = r(c, "center", 0, 0) + r(c, "top", 0, b) + r(c, "bottom", 0, -b) + r(c, "left", a, 0) + r(c, "right", -a, 0);
                    b = document.createElement("style");
                    void 0 !== b.cssText ? b.cssText = a : b.innerHTML = a;
            ...
            g.getOrientationSpecificPage = function(a, c) {
                var b = this.getPage(c),
                    d = b.getAttribute("alt-orientation-page");
                if (!d) return b;
                var e = b.isPortrait(),
                    h = 1 == a,
                    d = this.getPage(d);
    ...
    <script data-source="gwddoubleclick_min.js" data-version="10" data-exports-type="gwd-doubleclick" type="text/javascript">
        - function() {
            "use strict";
            var f;
            var h = function(a, b) {
            ...
            n.prototype.add = function(a, b) {
                var d = "string" == typeof a ? a : a.getString();
                this.i[d] || (this.i[d] = []);
                this.i[d].push(b)
            };
            var p = function(a) {
                    var b = [],
                        ...
                        c;
                    for (c in a.i) b.push(d ? new gwd.GwdId(c) : c);
                    return b
                },
                q = function(a, b) {
                    return b ? a.i["string" == typeof b ? b : b.getString()] || [] : []
                };
            ...
            r.prototype.observe = function(a) {
                if (a.nodeType == Node.ELEMENT_NODE)
                    for (var b = p(this.c), d = 0; d < b.length; d++) {
                        var c = t(b[d]);
                        if (c && h(a, c)) {
                            var e = q(this.c, b[d]);
                            e && e.forEach(function(a) {
                                c.addEventListener(a.event, this.A, !1)
                            }.bind(this))
                        }
                    }
            };
            var u = function(a, b) {
                if (b.nodeType == Node.ELEMENT_NODE)
                    for (var d = p(a.c), c = 0; c < d.length; c++) {
                        var e = t(d[c]);
                        if (e && h(b, e)) {
                            var g = q(a.c, d[c]);
                            g && g.forEach(function(a) {
                                e.removeEventListener(a.event, this.A, !1)
                            }.bind(a))
                        }
                    }
            };
            ...
            var v = function() {};
            goog.inherits(v, HTMLElement);
            f = v.prototype;
            f.createdCallback = function() {
                document.body.style.opacity = "0";
                this.I = this.T.bind(this);
                this.C = this.V.bind(this);
                this.J = this.U.bind(this);
                this.o = this.S.bind(this);
                this.m = this.R.bind(this);
                this.s = m.bind(null, "expandfinish", this);
                this.l = m.bind(null, "collapsefinish", this);
                this.A = this.F.bind(this);
                ...
                this.G = [];
                this.u = !1;
                this.ba = this.hasAttribute("fullscreen");
                this.j = null;
                this.f = !1;
                this.B = window.innerHeight >= window.innerWidth ? 1 : 2;
                this.b = null
            };
            f.attachedCallback = function() {
                Enabler.addEventListener(studio.events.StudioEvent.EXPAND_START, this.o);
                Enabler.addEventListener(studio.events.StudioEvent.COLLAPSE_START, this.m);
                Enabler.addEventListener(studio.events.StudioEvent.FULLSCREEN_EXPAND_START, this.o);
                Enabler.addEventListener(studio.events.StudioEvent.FULLSCREEN_COLLAPSE_START, this.m);
                Enabler.addEventListener(studio.events.StudioEvent.EXPAND_FINISH, this.s);
                Enabler.addEventListener(studio.events.StudioEvent.COLLAPSE_FINISH, this.l);
                Enabler.addEventListener(studio.events.StudioEvent.FULLSCREEN_EXPAND_FINISH,
                    this.s);
                Enabler.addEventListener(studio.events.StudioEvent.FULLSCREEN_COLLAPSE_FINISH, this.l);
                this.a = this.querySelector("[is=gwd-pagedeck]");
                this.a.addEventListener("pagetransitionend", this.L, !1);
                ...
                if (a)
                    for (var a = Array.prototype.slice.call(a.getElementsByTagName("gwd-metric-event")), d = 0; d < a.length; d++) {
                        var c = a[d],
                            e = c.getAttribute("source");
                        if (e) {
                            var g = c.getAttribute("exit"),
                                c = {
                                    event: c.getAttribute("event"),
                                    Y: c.getAttribute("metric") || g,
                                    O: c.hasAttribute("cumulative"),
                                    exit: g
                                };
                            b.add(w(e), c)
                        }
                ...
                this.c = b;
                this.K = new r(this.c, this.A);
                window.addEventListener("resize", this.M, !1)
            };
            f.detachedCallback = function() {
                Enabler.removeEventListener(studio.events.StudioEvent.INIT, this.I);
                Enabler.removeEventListener(studio.events.StudioEvent.VISIBLE, this.C);
                Enabler.removeEventListener(studio.events.StudioEvent.PAGE_LOADED, this.J);
                Enabler.removeEventListener(studio.events.StudioEvent.EXPAND_START, this.o);
                Enabler.removeEventListener(studio.events.StudioEvent.COLLAPSE_START, this.m);
                Enabler.removeEventListener(studio.events.StudioEvent.FULLSCREEN_EXPAND_START, this.o);
                Enabler.removeEventListener(studio.events.StudioEvent.FULLSCREEN_COLLAPSE_START,
                    this.m);
                Enabler.removeEventListener(studio.events.StudioEvent.EXPAND_FINISH, this.s);
                Enabler.removeEventListener(studio.events.StudioEvent.COLLAPSE_FINISH, this.l);
                Enabler.removeEventListener(studio.events.StudioEvent.FULLSCREEN_EXPAND_FINISH, this.s);
                Enabler.removeEventListener(studio.events.StudioEvent.FULLSCREEN_COLLAPSE_FINISH, this.l);
                this.a.removeEventListener("pagetransitionend", this.L, !1);
                window.removeEventListener("resize", this.M, !1)
            };
            f.initAd = function() {
                this.u = !1;
                var a = this.I;
            ...
            f.exit = function(a, b, d, c) {
                Enabler.exit(a, b);
                ("undefined" == typeof c || c) && x(this);
                d && this.goToPage()
            };
            f.exitOverride = function(a, b, d, c) {
            ...
            f.F = function(a) {
                ...
                e.exit && a.detail && a.detail.url ? (Enabler.exitOverride(d + ": " + e.exit, a.detail.url), a.detail.handled = !0, a.detail.collapse && this.goToPage()) : (a = l(b)) && a.gwdIsActive() && this.incrementCounter(e.Y || c, e.O)
            };
            f.T = function() {
            ...
            v.prototype.V = function(a) {
                if (this.u) this.b && z(this);
                else {
                    var b;
                    a && (b = a.detail);
                    a = this.aa.bind(this, b);
                    if (this.b)
                        if (this.b) {
                            b = this.b.getData();
                            var d = this.Z.bind(this, a);
                            b ? d() : a();
                            this.b.addEventListener("ready", d)
                        } else a();
                    else a()
                }
            };
            ...
            var z = function(a) {
                ...
                if (0 < b.length) {
                    var b = b[0],
                        d = a.b.getData(),
                        c = a.a.getElementsBySelector("*"),
                        c = c.concat(a.a.getPages());
                    b.bindData(d, c)
                }
            };
            v.prototype.aa = function(a) {
                this.u || (this.u = !0, document.body.style.opacity = "", m("adinitialized", this, a), this.goToPage())
            };
            v.prototype.goToPage = function(a, b, d, c, e) {
                var g = this.a.getPage(this.a.currentIndex);
                if (a = a ? this.a.getPage(a) : this.a.getDefaultPage()) this.g = a.id, b && (this.h = {
                    transition: b,
                    duration: d,
                    P: c,
                    direction: e
                }), g && a && !this.w && !g.hasAttribute("expanded") && a.hasAttribute("expanded") ? A(this) : g && a && !this.v && g.hasAttribute("expanded") && !a.hasAttribute("expanded") ? this.f ? Enabler.requestFullscreenCollapse() : Enabler.requestCollapse() : (this.v = this.w = !1, this.D())
            };
            var A = function(a) {
                if (a.ba && !1 !== a.j)
                    if (a.j) a.f = !0, Enabler.requestFullscreenExpand();
                    else {
                        var b = function(a) {
                            (this.j = !!a.supported) && m("fullscreensupport", this);
                            A(this);
            ...
            f.S = function() {
                m("expandstart", this);
                this.w = !0;
                this.f ? Enabler.finishFullscreenExpand() : Enabler.finishExpand();
                setTimeout(this.D.bind(this), 30)
            };
            f.R = function() {
                m("collapsestart", this);
                this.v = !0;
                this.f ? (Enabler.finishFullscreenCollapse(), this.f = !1) : Enabler.finishCollapse();
                this.g || (this.reportManualClose(), this.g = this.a.getDefaultPage().id);
                setTimeout(this.D.bind(this), 30)
            };
            f.X = function() {
                if (!this.g) {
            ...
            f.D = function() {
                if (this.g) {
                    this.B = window.innerHeight >= window.innerWidth ? 1 : 2;
                    var a = this.a.getOrientationSpecificPage(this.B, this.g);
                    this.h ? this.a.goToPage(a.id, this.h.transition, this.h.duration, this.h.P, this.h.direction) : this.a.goToPage(a.id);
                    this.f && a.classList.add("fs")
                }
            ...
            f.W = function(a) {
                ...
                if (a.target == this.a) {
                    ...
                    a = b.outgoingPage;
                    b = b.incomingPage;
                    if (a && (u(this.K, a), (a = a.querySelectorAll("video")) && 0 < a.length))
                        for (this.H = []; this.G.length;) studio.video.Reporter.detach(this.G.shift());
                    this.K.observe(b);
                    if ((a = b.querySelectorAll("video")) && 0 < a.length) {
                        var b = studio.video && studio.video.Reporter,
                            d = this.$.bind(this);
                        this.H = Array.prototype.slice.call(a);
                        b ? d() : Enabler.loadModule(studio.module.ModuleId.VIDEO, d)
                    }
                }
            };
            f.$ = function() {
                for (var a, b; this.H.length;)
                    if (b = this.H.shift(), a = w(b)) studio.video.Reporter.attach(a, b, b.autoplay), this.G.push(a)
            };
            var w = function(a) {
            ...
            v.prototype.attributeChangedCallback = null;
            document.registerElement("gwd-doubleclick", {
                prototype: v.prototype
            });
        }()
    </script>
    <script data-source="gwdimage_min.js" data-version="7" data-exports-type="gwd-image" type="text/javascript">
        - function() {
            "use strict";
            var c = function(a) {
                    return "gwd-page" == a.tagName.toLowerCase() || "gwd-page" == a.getAttribute("is")
            ...
            g.prototype.createdCallback = function() {
                ...
                this.addEventListener("load", this.b, !1);
                this.addEventListener("error", this.b, !1)
            };
    ...
    <script data-source="gwdrectangle_min.js" data-version="3" data-exports-type="gwd-rectangle" type="text/javascript">
        - function() {
            "use strict";
            var q = [0, 0, 0, 0],
                r = /[-+]?[0-9]*\.?[0-9]+%/g,
                ...
                w = function(f, b, g, a, d) {
                    ...
                    if (b.gradientMode) {
                        ...
                        if ("radial" == b.gradientMode) {
                            ...
                            var l = d[3][0] - d[0][0];
                            d = d[1][1] - d[0][1];
                            .001 < Math.abs(l) && (d /= l, k = Math.sqrt(k * k + c * c / (d * d)), c = d * k);
                            d = k;
                ...
                u = function(f, b, g) {
                    return f ? f = 0 <= f.indexOf("%") ? b + parseInt(f, 10) / 100 * (g - b) : 0 <= f.indexOf("px") ?
    ...
    <script data-source="gwdtaparea_min.js" data-version="4" data-exports-type="gwd-taparea" type="text/javascript">
        - function() {
            "use strict";
            var b;
            ...
            document.addEventListener("click", function(a) {
                for (var c = 0; c < f.length; c++)
                    if (25 > Math.abs(a.clientX - f[c].m) && 25 > Math.abs(a.clientY - f[c].o) || 25 > Math.abs(a.screenX - f[c].A) && 25 > Math.abs(a.screenY - f[c].B)) f.splice(c, 1), a.stopPropagation(), a.preventDefault()
            }, !0);
            var k = function() {};
    ...
    <script>
    	var openUrl;
    	function clickTag(){
    		openUrl=window.open("http://ad.zanox.com/ppc/?38116541C1110369904&ULP=", '_blank');
    	}
    </script>
...
<body>
    <gwd-doubleclick id="gwd-ad" polite-load="">
        <gwd-metric-configuration>
            <gwd-metric-event source="click" event="tapareaexit" metric=""></gwd-metric-event>
        </gwd-metric-configuration>
        <div is="gwd-pagedeck" class="gwd-page-container" id="pagedeck">
            <div is="gwd-page" id="page1" class="gwd-page-wrapper gwd-page-size gwd-lightbox gwd-div-wxlk" data-gwd-width="160px" data-gwd-height="600px" style="">
                <div class="gwd-page-content gwd-page-size gwd-div-nusn" style="">
                    <img is="gwd-image" source="http://d2qrtxdwnxepsi.cloudfront.net/zanox/160x600_bg.jpg" id="bg" class="gwd-img-c9f3" style="">
                    <canvas is="gwd-rectangle" width="160" height="60" class="gwd-canvas-ora7" x-off="0" y-off="0" stroke-width="1" stroke-color="null" fill-color="[1,1,1,1]" tl-radius="0" tr-radius="0" bl-radius="0" br-radius="0" stroke-style="Solid" style=""></canvas>
                    <div class="gwd-div-b1kl gwd-gen-1wi2gwdanimation" id="txt_phase_01"><span class="gwd-span-1ayc" style="">¿Estás buscando un coche de alquiler <strong class="gwd-strong-dgvt">barato</strong> para tus siguientes <span class="gwd-span-abyv">vacaciones?</span>
                        <br class="">
                        </span>
                    </div>
                    <div class="gwd-div-1ojk gwd-gen-oxzogwdanimation" id="txt_phase_02"><span class="gwd-span-1naj">¡Rerserva<br> uno en </span><span class="gwd-span-bv3u">HAPPYCAR</span><span class="gwd-span-1by0"> y ahorra hasta un </span><span class="gwd-span-1h4k">60%!</span>
                        <br class="gwd-br-16aj" style="">
                    </div>
                    <img is="gwd-image" source="http://d2qrtxdwnxepsi.cloudfront.net/zanox/HappyCar_Logo_es.png" id="gwd-image_1" class="gwd-img-vk75" style=""><span class="gwd-span-1ku0 gwd-gen-1dltgwdanimation" id="txt_phase_03"><span class="gwd-span-1jia">¡En todo el mundo a partir de </span><span class="gwd-span-wouw gwd-span-1q9q">6€</span>
                    <br class=""><span class="gwd-span-9z2p gwd-span-1he0"> al día!</span></span>
                    <span class="gwd-span-1ohi gwd-gen-1n2hgwdanimation" id="BTN" style="">¡Rerserva<br class=""> ahora y ahorra!</span>
                    <canvas is="gwd-rectangle" width="272" height="111" class="gwd-canvas-j6bx gwd-gen-o2rngwdanimation" x-off="0" y-off="0" stroke-width="1" stroke-color="null" fill-color="[1,1,1,1]" tl-radius="0" tr-radius="0" bl-radius="0" br-radius="0" stroke-style="Solid"></canvas>
                    <img is="gwd-image" source="http://d2qrtxdwnxepsi.cloudfront.net/zanox/bmw_1.jpg" id="car_01" class="gwd-img-ivw6 gwd-gen-fbafgwdanimation">
                    <img is="gwd-image" source="http://d2qrtxdwnxepsi.cloudfront.net/zanox/vw_passat.jpg" id="car_02" class="gwd-img-5n1j gwd-gen-q02tgwdanimation">
                    <canvas is="gwd-rectangle" width="122" height="41" class="gwd-canvas-hle8 gwd-gen-1njzgwdanimation" x-off="-0.23833501338955898" y-off="-0.1419982910156321" stroke-width="1" stroke-color="null" fill-color="[0.9529411764705882,0.5647058823529412,0.043137254901960784,1]" tl-radius="0" tr-radius="0" bl-radius="0" br-radius="0" stroke-style="Solid"></canvas><span class="gwd-span-1e1e gwd-gen-1mk0gwdanimation"><span class="gwd-span-15k8">P. ej. un </span><span class="gwd-span-tiay">BMW 1</span><span class="gwd-span-2wl8"> or un </span><span class="gwd-span-pl27">VW Passat</span>
                    <br class="" style="">
                    </span>
                    <gwd-taparea id="click" class="gwd-taparea-1pin" onclick="clickTag()"></gwd-taparea>
                </div>
            </div>
        </div>
    </gwd-doubleclick>
    ...
    <script data-exports-type="gwd-studio-registration">function StudioExports() { Enabler.counter("click: tapareaexit"); }
    </script>
    <script type="text/gwd-admetadata">{"version":1,"type":"DoubleClick","format":"","template":"","politeload":true,"fullscreen":false,"counters":[{"source":"click","metric":"click: tapareaexit"}],"timers":[],"exits":[],"creativeProperties":{"minWidth":160,"minHeight":600,"maxWidth":160,"maxHeight":600},"components":["gwd-taparea","gwd-image","gwd-doubleclick","gwd-page","gwd-pagedeck","gwd-rectangle"]}</script>
</body>
...
<!--                        <div class="sidebar-block">
                ...
                <div class="col-xs-12 col-sm-8 col-md-9">
                                        ...
                                        <div class="table-view">
                                            ...
                                            <div class = "title hotel-middle clearfix cell-view">   
                                             ...
                                             <!--   <h2><?php echo "REF:".$property->property_id ?> </h2> -->                                         
                                                ...
                                                <p class = "f-14 grid-hidden"><?php echo $property->location_address."<br>Camas dobles: ".$property->beds_double_beds."<br>"; 
												
												  if ($property->beds_double_sofa_beds > 0 ) echo "Sofás Camas: ".$property->beds_double_sofa_beds."<br>";
												  if ($property->beds_single_sofa_beds > 0 ) echo "Sofás Camas: ".$property->beds_single_sofa_beds."<br>";
												
												?></p>  
                                            </div>                        
                                            <div class = "title hotel-right clearfix cell-view">        
                                                <div class = "hotel-person color-dark-2">from <span class = "color-blue"><?php echo $property->pricing_price . ' ' . $property->pricing_currency		
																					
												   ?></span> person</div>  
                                                <a class = "c-button b-40 bg-blue hv-blue-o grid-hidden" href = "<?php echo $property->urls_name ?>"  rel="nofollow"   target="_blank" >view more</a>   
                                            </div>                            
                                        </div>       
                                    </div> 
                                </div>             
                    ...
                    <div class="c_pagination clearfix padd-120">										
                        ...
                        <ul class="cp_content color-1">																		<?php echo $paginacion; ?>
