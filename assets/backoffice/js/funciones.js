$(document).ready(function () {
    ...
    $('.dia').on('click', function () {
        ...
        $('.dia').css('background-color', '#FF4000');
        //obtenemos el número del día
        var num_dia = $(this).find('div').html();
        
        //alert("Dia Pulsado"+num_dia);
        ...
        if (num_dia != null) {
            ...
            if (citas == 'oc_11')
            {
                year = $('.year').val();
                month = $(".month").val();
                //Dia ocupado , al darle click lo ponemos como disponible
                $.ajax({
                    type: 'POST',
                    // url : 'https://holidayapartment.online/calendario/coger_hora',
                    url: 'https://holidayapartment.online/backoffice/reservar_dia',
                    data: {
                        'num': num_dia,
                        'year': year,
                        'month': month,
